...
- I can describe some common techniques for refactoring
- I can explain how these patterns can be implemented
- I can implement these patterns to improve code quality
